...
public class DatePicker extends JPanel {
	...
	private static view.Calendar cal; 
    ...
    public DatePicker(view.Calendar calen) {
        super();
    ...
    protected void createPanel() {
        ...
        setPreferredSize(new Dimension(459, 221));
    }
...
//              System.out.print("Draw month: " + draw.get(Calendar.MONTH));
                if (draw.get(Calendar.MONTH) == monthInt) {
                  String dayString = dayName.format(draw.getTime());
                    ...
                    dayButton.addMouseListener(new MouseAdapter() {
            			...
            			public void mouseClicked(MouseEvent arg0) {
            				try {
            					...
            					changeDay(dayButton.getText());
            					int dayy;
            					String[] parts = dayButton.getText().split(" ");
            					if(parts.length==1) dayy=Integer.parseInt(parts[0]);
            					else dayy=Integer.parseInt(parts[1]);
         
            					setDate(monthInt+1, dayy, getYear());
            					//System.out.println(dayButton.getText());
            					//System.out.println(textField.getText());
            					          					
            					cal.uploadDate(textField.getText());
                    ...
                    dayButton.setToolTipText(textField.getText());
...
//          if (draw.get(Calendar.MONTH) != monthInt) break;
    ...
    public static void main(view.Calendar cal) {
		...
		final DatePicker dp = new DatePicker(cal);
